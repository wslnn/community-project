...
public class LogInController implements CommunityConstant {
    ...
    public String register(Model model, User user){
        ...
        if(map == null||map.isEmpty()){
            model.addAttribute("msg","注册成功，我们已经向您的邮箱发生了一封激活邮件，请尽快激活");
    ...
    public String activation(Model model, @PathVariable("userId") int userId,@PathVariable("code") String code){
        ...
        if(result == ACTIVATION_SUCCESS){
            ...
            model.addAttribute("msg","无效的操作，该账号已被激活");
            model.addAttribute("target","/index");
        }else {
            model.addAttribute("msg","激活失败，该激活码无效");
            model.addAttribute("target","/index");
        }
        return "/site/operate-result";
    }
...
//        String kaptcha = (String) session.getAttribute("kaptcha");
        ...
        //检查账号,密码
        int expiredSeconds = rememberme ? REMEBER_EXPIRED_SECONDS : DEFAULT_DISPIRED_SECONDS;
