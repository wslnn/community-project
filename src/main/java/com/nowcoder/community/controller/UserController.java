...
public class UserController {
    ...
    public String updatePassword(String oldPassword, String newPassword, String newPasswordConfirm,
        ...
        Map<String, Object> map = userService.updatePassword(oldPassword, newPassword, newPasswordConfirm);
        ...
        model.addAttribute("newPasswordConfirmMsg",map.get("newPasswordConfirmMsg"));
